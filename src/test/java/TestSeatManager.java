...
public class TestSeatManager {
    ...
    public void testCalculateRefundByDaysLeft() {
        ...
        assertEquals(200.0, full_refund,0);
        ...
        assertEquals(148.0, partial_refund,0);
    ...
    public void testCalculateDateChangeChargeByDateLeft() {
        ...
        assertEquals(0.0, no_charge,0);

        // charged $46 if date is changed 5 days before the departure date
        double charge1 = seatManager.calculateDateChangeChargeByDateLeft(5, 28);
        assertEquals(46.0, charge1,0);
